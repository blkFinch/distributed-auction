...
public class itemSpecsList {
    protected static ArrayList<ItemSpecs> itemSpecsList;
    ...
    public static ItemSpecs getRandomElement() {
        ...
        int size = itemSpecsList.size();
        ItemSpecs itemSpecs = itemSpecsList.get(random.nextInt(size));
        itemSpecsList.remove(itemSpecs);
        return itemSpecs;
    }
}
